...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! axios */ "./frontend/node_modules/axios/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    axios: axios__WEBPACK_IMPORTED_MODULE_26___default.a,
  ...
  methods: {
    getinspectiondata: function getinspectiondata(vin_number) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_26___default.a.post('http://koboautos.com/twic-terminal/connect/api/inspection-details-by-vin-number?vin_number=' + vin_number).then(function (response) {
    ...
    uploaddocuments: function uploaddocuments() {
      ...
      if (this.AddInspectionDocuments.title != '') {
        ...
        reader.onload = function () {
          ...
          axios__WEBPACK_IMPORTED_MODULE_26___default.a.post('http://koboautos.com/twic-terminal/connect/api/upload-documents', {
            ...
            _c(
              ...
              [
                _c(
                  "b-card-header",
                  [
                    _c("b-card-title", [_vm._v(" Work Order")]),
                    _vm._v(" "),
                    _c("feather-icon", {
                      directives: [
                        {
                        ...
                        {
                          name: "b-toggle",
                          rawName: "v-b-toggle.work-order",
                          modifiers: { "work-order": true }
                        }
                      ],
                      staticClass: "cursor-pointer",
                      attrs: {
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "tbody",
                          { attrs: { role: "rowgroup" } },
                          _vm._l(_vm.InspectionWorkOrder, function(
                            wkorder,
                            key
                          ) {
                            return _c("tr", [
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    {
                                      attrs: {
                                        to: "/apps/invoice/preview/4987"
                                      }
                                    },
                                    [_vm._v(_vm._s(wkorder.work_order_number))]
                                  )
                                ],
                                1
                              ),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(wkorder.added_on))]),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(wkorder.total_price))]),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(wkorder.status))]),
                              _vm._v(" "),
                              _c("td")
                            ])
                          }),
