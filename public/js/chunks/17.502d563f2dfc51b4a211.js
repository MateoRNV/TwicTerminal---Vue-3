...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/router/routes/app'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var onSubmit = function onSubmit() {
      ...
      _this.$router.go("/inventory/list/" + id); //router.replace('/inspection-types');
