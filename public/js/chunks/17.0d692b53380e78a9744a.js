  ...
  methods: {
    formSubmit: function formSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default()({
        method: 'post',
        url: 'http://koboautos.com/twic-terminal/connect/api/create_inspections?vin_numbessr=' + this.userData.value.vin_number + '&driver_name=' + this.userData.value.driver_name + '&company_name=' + this.userData.value.companyName + '&customer=Abdul sSalam'
      }).then(function (response) {
        console.log(response);
