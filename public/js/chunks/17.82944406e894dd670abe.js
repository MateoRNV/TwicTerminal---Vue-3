...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    vindecorder: function vindecorder(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://koboautos.com/twic-terminal/scrapping/getcrossdata/decodevin.php?vin=' + vin_number).then(function (response) {
