...
function useUsersList() {
  ...
  var genderFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])(null);
  ...
  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["watch"])([currentPage, perPage, searchQuery, roleFilter, planFilter, statusFilter, genderFilter], function () {
    refetchData();
  });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var _useUsersList = Object(_useUsersList__WEBPACK_IMPORTED_MODULE_6__["default"])(),
        ...
        genderFilter = _useUsersList.genderFilter,
    ...
    [
      _c("user-list-add-new", {
        attrs: {
          ...
          "plan-options": _vm.genderOptions
        },
        on: {
      ...
      _c("users-list-filters", {
        ...
        on: {
          ...
          "update:genderFilter": function($event) {
            _vm.genderFilter = $event
          },
          "update:gender-filter": function($event) {
            _vm.genderFilter = $event
          },
              ...
              _c(
                ...
                [
                  ...
                  _c("v-select", {
                    ...
                    on: {
                      input: function(val) {
                        return _vm.$emit("update:genderFilter", val)
                      }
                    }
                  })
                ],
