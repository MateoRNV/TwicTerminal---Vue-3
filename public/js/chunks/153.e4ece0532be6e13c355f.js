...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteVehicleCategories: function deleteVehicleCategories(rowid) {
      ...
      alert();
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/delete-vehicle-categories?key=" + rowid).then(function (response) {
        _this2.VehicleCategories = _this2.VehicleCategories.filter(function (VehicleCategories) {
          return VehicleCategories.id != rowid;
        });
