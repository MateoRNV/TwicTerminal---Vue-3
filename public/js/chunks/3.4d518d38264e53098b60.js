...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    postData: function postData(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/create-inspectiontype", {
                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.InspectionType.status, "A")
                              },
                              on: {
                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              ...
                              domProps: {
                                checked: _vm._q(_vm.InspectionType.status, "B")
                              },
                              on: {
                                change: function($event) {
                                  return _vm.$set(
