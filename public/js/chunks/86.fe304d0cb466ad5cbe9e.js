...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    uploaddocuments: function uploaddocuments() {
      ...
      var file = this.AddInspectionDocuments.file.files[0];
      var reader = new FileReader();

      reader.onload = function (e) {
        return _this2.$emit("load", e.target.result);
      };

      console.log(reader.readAsText(file)); //   var reader = new FileReader()
      // reader.readAsDataURL(this.AddInspectionDocuments.file.files[0])
      // reader.onload = ()=> {
