...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getinspectiondata: function getinspectiondata(vin_number) {
      axios__WEBPACK_IMPORTED_MODULE_22___default.a.post('http://koboautos.com/twic-terminal/connect/api/inspection-details-by-vin-number' + vin_number).then(function (response) {
