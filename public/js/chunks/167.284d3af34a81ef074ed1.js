...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    if (!store.hasModule(USER_APP_STORE_MODULE_NAME)) store.registerModule(USER_APP_STORE_MODULE_NAME, userStoreModule); // UnRegister on leave

    onUnmounted(function () {
      if (store.hasModule(USER_APP_STORE_MODULE_NAME)) store.unregisterModule(USER_APP_STORE_MODULE_NAME);
    });
    var isAddNewUserSidebarActive = ref(false);
    var roleOptions = [{
      label: 'Admin',
      value: 'admin'
    }, {
                      ...
                      [
                        _c(
                          "b-card",
                          {
                            ...
                            attrs: {
                              "no-body": "",
                              "is-add-new-user-sidebar-active":
                                _vm.isAddNewUserSidebarActive
                            },
                            on: {
                              "update:isAddNewUserSidebarActive": function(
                                $event
                              ) {
                                _vm.isAddNewUserSidebarActive = $event
                              },
                              "update:is-add-new-user-sidebar-active": function(
                                $event
                              ) {
                                _vm.isAddNewUserSidebarActive = $event
                              }
