...
/* harmony import */ var _invoiceStoreModule__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../invoiceStoreModule */ "./frontend/src/views/apps/invoice/invoiceStoreModule.js");
/* harmony import */ var _InvoiceSidebarSendInvoice_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../InvoiceSidebarSendInvoice.vue */ "./frontend/src/views/apps/invoice/InvoiceSidebarSendInvoice.vue");
/* harmony import */ var _InvoiceSidebarAddPayment_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../InvoiceSidebarAddPayment.vue */ "./frontend/src/views/apps/invoice/InvoiceSidebarAddPayment.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    InvoiceSidebarSendInvoice: _InvoiceSidebarSendInvoice_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    InvoiceSidebarAddPayment: _InvoiceSidebarAddPayment_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  directives: {
  ...
  setup: function setup() {
    ...
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(INVOICE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(INVOICE_APP_STORE_MODULE_NAME, _invoiceStoreModule__WEBPACK_IMPORTED_MODULE_5__["default"]); // UnRegister on leave
    ...
    var invoiceData = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
    var paymentDetails = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({});
    _store__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('app-invoice/fetchInvoice', {
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\base\\pages\\app-invoice.scss 11:9            @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\invoice\\invoice-edit\\InvoiceEdit.vue 792:9                                                         root stylesheet");
