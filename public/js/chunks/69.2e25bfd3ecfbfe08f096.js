...
/* harmony import */ var _ChatLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ChatLeftSidebar.vue */ "./frontend/src/views/apps/chat/ChatLeftSidebar.vue");
/* harmony import */ var _chatStoreModule__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chatStoreModule */ "./frontend/src/views/apps/chat/chatStoreModule.js");
/* harmony import */ var _ChatActiveChatContentDetailsSidedbar_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ChatActiveChatContentDetailsSidedbar.vue */ "./frontend/src/views/apps/chat/ChatActiveChatContentDetailsSidedbar.vue");
/* harmony import */ var _ChatLog_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ChatLog.vue */ "./frontend/src/views/apps/chat/ChatLog.vue");
/* harmony import */ var _useChat__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./useChat */ "./frontend/src/views/apps/chat/useChat.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    // SFC
    ChatLeftSidebar: _ChatLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    ChatActiveChatContentDetailsSidedbar: _ChatActiveChatContentDetailsSidedbar_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    ChatLog: _ChatLog_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  setup: function setup() {
    var CHAT_APP_STORE_MODULE_NAME = 'app-chat'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_0__["default"].hasModule(CHAT_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_0__["default"].registerModule(CHAT_APP_STORE_MODULE_NAME, _chatStoreModule__WEBPACK_IMPORTED_MODULE_5__["default"]); // UnRegister on leave
    ...
    var _useChat = Object(_useChat__WEBPACK_IMPORTED_MODULE_8__["default"])(),
        resolveAvatarBadgeVariant = _useChat.resolveAvatarBadgeVariant; // Scroll to Bottom ChatLog


    var refChatLogPS = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
    ...
    var chatsContacts = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([]);
    var contacts = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([]);
    ...
    var activeChat = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({});
    var chatInputMessage = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('');
    ...
    var profileUserData = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({}); // ? Will contain id, name and avatar & status

    var profileUserDataMinimal = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({});
    var shallShowUserProfileSidebar = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false);
    ...
    var shallShowActiveChatContactSidebar = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false); // UI + SM Devices
    ...
    var startConversation = function startConversation() {
      if (_store__WEBPACK_IMPORTED_MODULE_0__["default"].state.app.windowWidth < _themeConfig__WEBPACK_IMPORTED_MODULE_2__["$themeBreakpoints"].lg) {
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _ChatContact_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ChatContact.vue */ "./frontend/src/views/apps/chat/ChatContact.vue");
/* harmony import */ var _UserProfileSidebar_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UserProfileSidebar.vue */ "./frontend/src/views/apps/chat/UserProfileSidebar.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    VuePerfectScrollbar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    // SFC
    ChatContact: _ChatContact_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    UserProfileSidebar: _UserProfileSidebar_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  props: {
    chatsContacts: {
      type: Array,
  ...
  setup: function setup(props) {
    ...
    var filteredChatsContacts = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      return props.chatsContacts.filter(searchFilterFunction);
    });
    var filteredContacts = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
