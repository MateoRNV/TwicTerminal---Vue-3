...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default()({
      method: "post",
      url: 'http://koboautos.com/twic-terminal/connect/api/update_user?key=' + rowid + '&first_name=' + this.customerinfo.first_name + '&last_name=' + this.customerinfo.last_name + '&email=' + this.customerinfo.email + '&phone=' + this.customerinfo.phone + '&gender=' + this.customerinfo.gender + '&password=' + this.customerinfo.password + '&address=' + this.customerinfo.address + '&country_id=' + this.customerinfo.country.key
    }).then(function (response) {
      console.log(response);
