  ...
  methods: {
    postData: function postData(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/create-settings", {
        ...
        status: this.InspectionType.status,
        key: this.InspectionType.key
      }, {
        headers: {
                      ...
                      _c(
                        ...
                        [
                          _c("b-form-input", {
                            ...
                            model: {
                              value: _vm.InspectionType.name,
                              callback: function($$v) {
                                _vm.$set(_vm.InspectionType, "name", $$v)
                              },
                              expression: "InspectionType.name"
                            }
                          })
                        ],
                        1
                          ...
                          [
                            _c(
                              "b-form-radio",
                              {
                                ...
                                model: {
                                  value: _vm.InspectionType.status,
                                  callback: function($$v) {
                                    _vm.$set(_vm.InspectionType, "status", $$v)
                                  },
                                  expression: "InspectionType.status"
                                }
                              },
                              [
                                _vm._v(
