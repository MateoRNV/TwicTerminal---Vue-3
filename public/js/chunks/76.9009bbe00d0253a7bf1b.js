...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getResults: function getResults() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://koboautos.com/twic-terminal/connect/api/customers-listing?page=' + page, {
        headers: {
                    ...
                    _c(
                      ...
                      [
                        _c("feather-icon", {
                          ...
                          class:
                            "text-" +
                            _vm.resolveUserRoleVariant(data.item.company),
                          attrs: {
                            icon: _vm.resolveUserRoleIcon(data.item.company),
                            size: "18"
                          }
                        }),
                        _vm._v(" "),
                    ...
                    _c(
                      ...
                      [
                        _c("feather-icon", {
                          ...
                          class:
                            "text-" +
                            _vm.resolveUserRoleVariant(data.item.phone),
                          attrs: {
                            icon: _vm.resolveUserRoleIcon(data.item.phone),
                            size: "18"
                          }
                        }),
                        _vm._v(" "),
                    ...
                    _c(
                      ...
                      [
                        _c("feather-icon", {
                          ...
                          class:
                            "text-" +
                            _vm.resolveUserRoleVariant(data.item.type),
                          attrs: {
                            icon: _vm.resolveUserRoleIcon(data.item.type),
                            size: "18"
                          }
                        }),
                        _vm._v(" "),
