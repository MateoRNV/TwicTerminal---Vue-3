...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var INVOICE_APP_STORE_MODULE_NAME = 'inventory'; // Register module

    if (!store.hasModule(INVOICE_APP_STORE_MODULE_NAME)) store.registerModule(INVOICE_APP_STORE_MODULE_NAME, _invoiceStoreModule__WEBPACK_IMPORTED_MODULE_19__["default"]); // UnRegister on leave
