...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var _useUsersList = Object(_useUsersList__WEBPACK_IMPORTED_MODULE_6__["default"])(),
        ...
        statusFilter = _useUsersList.statusFilter; //fill the users


    var users = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    var usersFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    ...
    var planFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(null);
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["watch"])([planFilter], function () {
      if (planFilter.value && planFilter.value != "all") {
        usersFilter.value = [];
        users.value.forEach(function (u) {
                    ...
                    data.item.user_assigned_terminals
                      ? _c(
                          ...
                          [
                            _vm._v(
                              "\n          " +
                                _vm._s(data.item.user_assigned_terminals) +
                                "\n        "
                            )
                          ]
                        )
                  ...
                  _c(
                    ...
                    [
                      _c("span", { staticClass: "text-muted" }, [
                        ...
                        _vm.dataMeta.from + _vm.perPage < _vm.usersFilter.length
                          ? _c("span", [
                              _vm._v(
                                "\n              " +
                                  _vm._s(_vm.dataMeta.from + _vm.perPage - 1) +
                                  "\n            "
                              )
                            ])
                          : _c("span", [_vm._v(" " + _vm._s(_vm.perPage))]),
                        _vm._v(
                          " of " + _vm._s(_vm.usersFilter.length) + " entries"
                        )
                      ])
                    ]
                  ),
                  ...
                  _c(
                    ...
                    [
                      _c("b-pagination", {
                        ...
                        attrs: {
                          "total-rows": _vm.usersFilter.length,
                          "per-page": _vm.perPage,
