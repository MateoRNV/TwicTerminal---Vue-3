  ...
  methods: {
    ...
    getResults: function getResults() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://koboautos.com/twic-terminal/connect/api/all-customers-listing?page=' + page, {
        ...
        console.log(response.data.customers); // this.laravelData = response.data.Inspection;
                                            ...
                                            _c(
                                              ...
                                              [
                                                ...
                                                _c(
                                                  ...
                                                  [
                                                    _vm._v(
                                                      "Inland or Ocean Transportation agent"
                                                    )
                                                  ]
                                                )
                                              ]
          ...
          _c(
            ...
            [
              ...
              _c(
                "tbody",
                { attrs: { role: "rowgroup" } },
                _vm._l(_vm.customers.data, function(customer, key) {
                  return _c(
                    "tr",
                    {
                      attrs: {
                              ...
                              [
                                _c(
                                  "router-link",
                                  {
                                    ...
                                    attrs: {
                                      to: "/categories/update/" + customer.id
                                    }
                                  },
                                  [
                                    _vm._v(
                                ...
                                _vm._v(" "),
                                customer.typeinfo !== null
                                  ? _c("small", { staticClass: "text-muted" }, [
                                      _vm._v(_vm._s(customer.typeinfo.title))
                                    ])
                                  : _vm._e()
                              ],
                              1
                              ...
                              _c(
                                "ul",
                                {
                                  ...
                                  attrs: {
                                    role: "menu",
                                    tabindex: "-1",
                                    "aria-labelledby": "__BVID__292__BV_toggle_"
                                  }
                                },
                                [
                                  _c(
