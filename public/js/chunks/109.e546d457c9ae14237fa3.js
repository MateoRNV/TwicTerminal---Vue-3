  ...
  data: function data() {
    return {
      ...
      notesData: [{
        mode: 'John Doe',
        avatarVariant: 'light-info',
        notes: 'A description list is perfect for defining terms.',
        payment: 'John Doe',
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              "b-card-body",
                              _vm._l(_vm.notesData, function(notes) {
                                return _c(
                                  "div",
                                  {
                                    key: notes.mode,
                                  ...
                                  [
                                    ...
                                    _c(
                                      "div",
                                      {
                                        ...
                                        class: notes.deduction
                                          ? "text-primary"
                                          : "text-info"
                                      },
                                      [
                                        _c("p", { staticClass: "mb-0" }, [
                                          _vm._v(_vm._s(notes.note))
                                        ]),
                                        _vm._v(" "),
                                        _c("p", { staticClass: "mb-0" }, [
                                          _vm._v(_vm._s(notes.activitycreated))
                                        ])
                                      ]
                                    )
                                  ],
