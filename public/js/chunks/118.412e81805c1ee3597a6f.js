...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    postData: function postData(e) {
      console.log(this.statusList.title);
      console.log(this.phoneNumbers.phone);
      var currentObj = this;
                  ...
                  [
                    _vm._l(_vm.items, function(item, index) {
                      return _c(
                        ...
                        [
                          _vm._l(_vm.phoneNumbers, function(input, index) {
                            return _c(
                              "div",
                              {
                                key: "phoneInput-" + index,
                                staticClass: "input wrapper flex items-center"
                              },
                              [
                                _c("input", {
                                  staticClass:
                                    "h-10 rounded-lg outline-none p-2",
                                  attrs: {
                                    type: "text",
                      ...
                      [
                        _c(
                          "b-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.addField(_vm.input, _vm.phoneNumbers)
                              }
                            }
                          },
