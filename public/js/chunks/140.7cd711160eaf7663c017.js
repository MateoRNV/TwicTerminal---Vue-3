...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formSubmit: function formSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post('"http://koboautos.com/twic-terminal/connect/api/update-status-list?', this.formfields).then(function (response) {
