...
function useUsersList() {
  ...
  var refUserListTable = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null); // Table Handlers
  ...
  var totalUsers = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(0);
  ...
  var roleFilter = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
  var planFilter = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
  ...
  !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([currentPage, perPage, searchQuery, roleFilter, planFilter, statusFilter], function () {
    refetchData();
  });
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _users_list_useUsersList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../users-list/useUsersList */ "./frontend/src/views/apps/user/users-list/useUsersList.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    var _useUsersList = Object(_users_list_useUsersList__WEBPACK_IMPORTED_MODULE_3__["default"])(),
    ...
    var previewEl = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var userDataInfo = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
      dob: null,
      mobile: '+6595895857',
...
/* harmony import */ var _userStoreModule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../userStoreModule */ "./frontend/src/views/apps/user/userStoreModule.js");
/* harmony import */ var _UserEditTabAccount_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./UserEditTabAccount.vue */ "./frontend/src/views/apps/user/users-edit/UserEditTabAccount.vue");
/* harmony import */ var _UserEditTabInformation_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./UserEditTabInformation.vue */ "./frontend/src/views/apps/user/users-edit/UserEditTabInformation.vue");
/* harmony import */ var _UserEditTabSocial_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./UserEditTabSocial.vue */ "./frontend/src/views/apps/user/users-edit/UserEditTabSocial.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    UserEditTabAccount: _UserEditTabAccount_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    UserEditTabInformation: _UserEditTabInformation_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    UserEditTabSocial: _UserEditTabSocial_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  setup: function setup() {
    var userData = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
    var USER_APP_STORE_MODULE_NAME = 'app-user'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_2__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_2__["default"].registerModule(USER_APP_STORE_MODULE_NAME, _userStoreModule__WEBPACK_IMPORTED_MODULE_3__["default"]); // UnRegister on leave
