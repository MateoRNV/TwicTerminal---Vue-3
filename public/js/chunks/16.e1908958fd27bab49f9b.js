...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var onSubmit = function onSubmit() {
      console.log(InventoryData); // store.dispatch('app-user/addUser', userData.value)
      //   .then(() => {
      //     emit('refetch-data')
    ...
    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_4__["default"])(resetInventoryData),
