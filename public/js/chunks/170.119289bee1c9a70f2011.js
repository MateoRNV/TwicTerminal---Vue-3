...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      tokens: "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6ImVkZjBiNzJhNzVlYmJmMDExZjYwOTEyMWNhMjI3NjM3ZWU4ZjhiZmI4ZjVhMTI0YjQwZTk2NTM4YzZkMmZkZjU4YzYzMzZmNzZiNDIyODYzIn0",
      // validation rules
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post("http://koboautos.com/twic-terminal/connect/api/login", {
        email: this.userEmail,
        password: this.password
      }, {
        headers: {
          Authorization: "Bearer ".concat(this.tokens)
        }
      }).then(function (res) {
        console.log(res.data);
      });
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post("http://koboautos.com/twic-terminal/connect/oauth/token", {
        token_name: "Terminal",
        client_id: "19384712",
        client_secret: "iTAxbwQAc7Ar6LR4HPiNalQ1yKzeOeQmy9QwUFtK",
        grant_type: ""
      }, {
        headers: {
          "content-type": "application/json",
          Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6IjIwZmYwMDdiMGFkNTU1OGI1ZjA5ZTBmNDdmMWIwYzQ3YWJlZWJkMDJiOThhNTcwOWYzYTZlYWFkZTVlMTgxZjkwMzk3YzcwZmM3ZWNlYTViIn0.eyJhdWQiOiIxMTkzODQ3IiwianRpIjoiMjBmZjAwN2IwYWQ1NTU4YjVmMDllMGY0N2YxYjBjNDdhYmVlYmQwMmI5OGE1NzA5ZjNhNmVhYWRlNWUxODFmOTAzOTdjNzBmYzdlY2VhNWIiLCJpYXQiOjE2MDUzNjk4NDQsIm5iZiI6MTYwNTM2OTg0NCwiZXhwIjoxNjM2OTA1ODQ0LCJzdWIiOiIiLCJzY29wZXMiOltdfQ.RaPxNHXDrx90_cJCheKKLO7PDAvcSyXVvD1EaDD_DLkibntghu3mEHosrGWVk_EMDBudzJfNW70ZP3pYsnBdfimsv5_dYbE8HKWGNYrdjnSZBzkxALZssWb9QiZgPHiwqdLLgnwbfv_OCxgHhpDvh7uRi3ikDHxsZC5_ce3hMFck8S2zra1km1zjN6b8XDchC7Bxy2phJJ2UeBjcRLrH5-mVC36-1Gf6_vKRNj1dLayfzCFcIsHMwFl-vLKEPspD7LxcIxukueXrGK2Kf1wblQg1QxN8dlxM4iHFvVdhmzkIGdb6Ro1JLzCDOesy3QPxmW9hshg7I8cEWlEflVnMcp0Fx-B-94ltYEM05QlRWVmy2eklJT9OsSdtnQYmsFJxq2L_4J01-Y3XqF_I-MOfB4ykxMq_ImKoLUKliT2B5JgoomZMoYxwbAhpo5qn042_-rCKEdkA2czr8dh1Q1h5JMrnNCQ6Dt7HtUujUn-l_3LavBJqHjJDRe34sA840UYCTKEgiXCi5mxUevVXjl-LGUz2p_u2wIz1ODTTpqKTV3nkzakvRiJTLo99THUcWf8bcLiuSY6powHh6j896kX6nIV-OK28geeW4MEBUt_zOARiIFLt09qVHlmajiSowk8eR0R0QQ-njyrcvhKD7AD15g5XreidWMCrmhgBuAJTABI"
        }
      }).then(function (response) {
        _this.tokens.response.data.access_token;
      });
