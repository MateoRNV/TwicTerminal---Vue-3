...
/* harmony import */ var _auth_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/auth/utils */ "./frontend/src/auth/utils.js");
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_2__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_2__["default"].setToken(response.data.accessToken);
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_2__["default"].setRefreshToken(response.data.refreshToken);
            ...
            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_6__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
              _this.$toast({
