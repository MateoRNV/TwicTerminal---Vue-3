  ...
  methods: {
    formSubmit: function formSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default()({
        method: 'post',
        url: 'http://koboautos.com/twic-terminal/connect/api/create_customer?first_name=' + this.userData.vin_number + '&last_name=' + this.userData.driver_name + '&email=' + this.userData.companyName + '&phone=' + this.userData.phone + '&gender=' + this.userData.gender + '&customer_type=' + this.userData.role + '&address=' + this.userData.contact
      }).then(function (response) {
