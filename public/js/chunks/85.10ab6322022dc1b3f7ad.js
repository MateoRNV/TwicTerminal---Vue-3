...
!(function webpackMissingModule() { var e = new Error("Cannot find module '/views/components/timeline/code'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      codeCustomContentWithIcon: !(function webpackMissingModule() { var e = new Error("Cannot find module '/views/components/timeline/code'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
