...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_components, "BFormGroup", bootstrap_vue__WEBPACK_IMPORTED_MODULE_0__["BFormGroup"]), _defineProperty(_components, "BForm", BForm), _defineProperty(_components, "BFormInvalidFeedback", BFormInvalidFeedback), _defineProperty(_components, "vSelect", vue_select__WEBPACK_IMPORTED_MODULE_1___default.a), _components),
  directives: {
    Ripple: vue_ripple_directive__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var blankvehicleCategory = {
      title: "",
      basis: "",
      part: "",
      unit: "",
    ...
    var vehicleCategory = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(JSON.parse(JSON.stringify(blankvehicleCategory)));

    var resetvehicleCategory = function resetvehicleCategory() {
      vehicleCategory.value = JSON.parse(JSON.stringify(blankvehicleCategory));
    };

    var onSubmit = function onSubmit() {
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch("app-user/addUser", vehicleCategory.value);
    };

    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_7__["default"])(resetvehicleCategory),
  ...
  methods: {
    ...
    //         return getvalue.push({ value: item.value });
    //     });
    // },
