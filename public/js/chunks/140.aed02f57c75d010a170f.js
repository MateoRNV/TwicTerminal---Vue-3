...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getResults: function getResults() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post('http://koboautos.com/twic-terminal/connect/api/inspectionfields', {
        headers: {
        ...
        _this.inspectionfields = response.data.types; // this.inventoryduration = response.data.inventoryduration;
          ...
          _c(
            ...
            [
              ...
              _c(
                "tbody",
                { attrs: { role: "rowgroup" } },
                _vm._l(_vm.inspectionfields, function(inspection, index) {
                  return _c("tr", [
