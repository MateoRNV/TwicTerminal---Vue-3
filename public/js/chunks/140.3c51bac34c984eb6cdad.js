...
/* harmony default export */ __webpack_exports__["default"] = (_components$mounted$m = {
  components: {
...
}, _defineProperty(_components$mounted$m, "mounted", function mounted() {
  console.log("Component mounted.");
  console.log(this.$route.params);
  this.getempdata(this.$route.params.id);
}), _defineProperty(_components$mounted$m, "data", function data() {
  return {
...
}), _defineProperty(_components$mounted$m, "methods", {
  //*******************************UPDATE Record
  formSubmit: function formSubmit(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_8___default()({
      method: "post",
      url: "http://koboautos.com/twic-terminal/connect/api/update-email-template?key=" + rowid,
