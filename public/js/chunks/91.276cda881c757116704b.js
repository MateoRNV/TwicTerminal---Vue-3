...
/* harmony import */ var _fake_db_data_other_countries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/@fake-db/data/other/countries */ "./frontend/src/@fake-db/data/other/countries.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BFormTextarea: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  ...
  setup: function setup() {
    var customer = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
      name: '',
      email: '',
      address: '',
      country: '',
    ...
    return {
      customer: customer,
      countries: _fake_db_data_other_countries__WEBPACK_IMPORTED_MODULE_1__["default"]
    };
  }
});
...
/* harmony import */ var _InvoiceSidebarAddNewCustomer_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../InvoiceSidebarAddNewCustomer.vue */ "./frontend/src/views/apps/invoice/InvoiceSidebarAddNewCustomer.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BPopover: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    InvoiceSidebarAddNewCustomer: _InvoiceSidebarAddNewCustomer_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  directives: {
    Ripple: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-ripple-directive'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    'b-toggle': !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  ...
  setup: function setup() {
    ...
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(INVOICE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(INVOICE_APP_STORE_MODULE_NAME, _invoiceStoreModule__WEBPACK_IMPORTED_MODULE_4__["default"]); // UnRegister on leave
    ...
    var clients = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([]);
    _store__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('app-invoice/fetchClients').then(function (response) {
    ...
    var invoiceData = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
      id: 5037,
      client: null,
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\vue\\libs\\vue-select.scss 4:9                @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\invoice\\invoice-add\\InvoiceAdd.vue 753:9                                                         root stylesheet");
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\base\\pages\\app-invoice.scss 11:9            @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\invoice\\invoice-add\\InvoiceAdd.vue 768:9                                                         root stylesheet");
