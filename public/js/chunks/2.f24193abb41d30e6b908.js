...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    axios.post('http://koboautos.com/twic-terminal/connect/api/create_group').then(function (response) {
      console.log(response);
      _this3.userinfo = response.data.customergroups; //this.customerinfo.customer_type = response.data.customergroups.customer_type;
    });
  }), _defineProperty(_methods, "allcountries", function allcountries(e) {
    var _this4 = this;
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          ...
                          callback: function($$v) {
                            _vm.$set(_vm.userinfo, "first_name", $$v)
                          },
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          ...
                          callback: function($$v) {
                            _vm.$set(_vm.userinfo, "last_name", $$v)
                          },
