...
/* harmony default export */ __webpack_exports__["default"] = (_data$components$setu = {
  data: function data() {
    return {
      customers: {}
    };
...
}, _defineProperty(_data$components$setu, "data", function data() {
  return {
    customersinfo: [],
    customers: []
  };
}), _defineProperty(_data$components$setu, "methods", {
