  ...
  data: function data() {
    return {
      ...
      transactionData: [{
        ...
        payment: 'JH4DA9340LS003571',
        deduction: true
      }, {
        mode: 'Year/Make/Model/Trim:',
        avatarVariant: 'light-info',
        payment: '1990 Acura Integra RS Coupe',
        deduction: false
      }, {
        mode: 'Body Type:',
        avatarVariant: 'light-info',
        payment: 'HATCHBACK 2-DR',
        deduction: false
      }, {
        mode: 'Engine Type - Volume:',
        avatarVariant: 'light-info',
        payment: '1.8L L4 DOHC 16V - 9.97',
        deduction: true
      }, {
        mode: 'Dimensions (Inches):',
        avatarVariant: 'light-info',
