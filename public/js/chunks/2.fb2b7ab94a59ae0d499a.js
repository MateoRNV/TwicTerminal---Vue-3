                      ...
                      _c(
                        ...
                        [
                          _c("b-form-input", {
                            ...
                            model: {
                              value: _vm.vehicleCategories.title,
                              callback: function($$v) {
                                _vm.$set(_vm.vehicleCategories, "title", $$v)
                              },
                              expression: "vehicleCategories.title"
                            }
                          })
                        ],
                        1
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("v-select", {
                                        ...
                                        model: {
                                          value: _vm.vehicleCategories.basis,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.vehicleCategories,
                                              "basis",
                                              $$v
                                            )
                                          },
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("v-select", {
                                        ...
                                        model: {
                                          value: _vm.vehicleCategories.part,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.vehicleCategories,
                                              "part",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("v-select", {
                                        ...
                                        model: {
                                          value: _vm.vehicleCategories.unit,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.vehicleCategories,
                                              "unit",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("v-select", {
                                        ...
                                        model: {
                                          value: _vm.vehicleCategories.operator,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.vehicleCategories,
                                              "operator",
                              ...
                              _c(
                                ...
                                [
                                  _c("b-form-input", {
                                    ...
                                    attrs: { "v-model": _vm.searchQuery },
                                    model: {
                                      value: _vm.vehicleCategories.value,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.vehicleCategories,
                                          "value",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("v-select", {
                                        ...
                                        model: {
                                          value:
                                            _vm.vehicleCategories.condition,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.vehicleCategories,
                                              "condition",
