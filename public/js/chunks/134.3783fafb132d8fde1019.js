...
!(function webpackMissingModule() { var e = new Error("Cannot find module './FormRepeaterBasic.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    FormRepeaterBasic: !(function webpackMissingModule() { var e = new Error("Cannot find module './FormRepeaterBasic.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  ...
  methods: {
    ...
    getstatusGroup: function getstatusGroup() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/status-group-list").then(function (response) {
        _this.statusGroup = response.data.statusgroup; // for (x in response.data.statusGroup) {
    ...
    initTrHeight: function initTrHeight() {
      ...
      this.trSetHeight(null);
      this.$nextTick(function () {
        _this3.trSetHeight(_this3.$refs.row.scrollHeight);
      });
    }
  }
});
                  ...
                  [
                    _vm._l(_vm.items, function(item, index) {
                      return _c(
                        ...
                        {
                          key: item.id,
                          attrs: { cols: "12", md: "10", id: item.id }
                        },
                        [
                          _c(
                            "b-row",
                                ...
                                _c(
                                  ...
                                  [
                                    _c("b-form-input", {
                                      ...
                                      model: {
                                        value: _vm.statusList.title,
                                        callback: function($$v) {
                                          _vm.$set(_vm.statusList, "title", $$v)
                                        },
                                        expression: "statusList.title"
                                      }
                                    })
                                  ],
                                  1
                                ...
                                _c(
                                  ...
                                  [
                                    _c("b-form-input", {
                                      ...
                                      model: {
                                        value: _vm.statusList.color,
                                        callback: function($$v) {
                                          _vm.$set(_vm.statusList, "color", $$v)
                                        },
                                        expression: "statusList.color"
                                      }
                                    })
                                  ],
                                  1
                            ...
                            [
                              _c("quill-editor", {
                                ...
                                model: {
                                  ...
                                  callback: function($$v) {
                                    _vm.$set(_vm.statusList, "description", $$v)
                                  },
