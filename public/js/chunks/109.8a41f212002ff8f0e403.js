            ...
            _c(
              ...
              [
                _c(
                  "b-form-group",
                  {
                    attrs: { label: "Vin Number", "label-for": "defaultLabel" }
                  },
                  [
                    _c("b-form-input", {
                      attrs: { id: "defaultLabel", placeholder: "Vin Number" }
                    })
                  ],
                  1
                )
            ...
            _c(
              ...
              [
                _c(
                  "b-form-group",
                  {
                    attrs: { label: "Body Type", "label-for": "defaultLabel" }
                  },
                  [
                    _c("b-form-input", {
                      attrs: { id: "defaultLabel", placeholder: "Body Type" }
                    })
                  ],
                  1
                )
            ...
            _c(
              ...
              [
                _c(
                  "b-form-group",
                  {
                    attrs: { label: "Curb Weight", "label-for": "defaultLabel" }
                  },
                  [
                    _c("b-form-input", {
                      attrs: { id: "defaultLabel", placeholder: "Curb Weight" }
                    })
                  ],
                  1
                )
