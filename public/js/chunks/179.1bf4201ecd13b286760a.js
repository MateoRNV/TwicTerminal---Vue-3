...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    removeItem: function removeItem(k, fieldType) {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("v-select", {
                                          ...
                                          model: {
                                            value: vehicleCategories.operator,
                                            callback: function($$v) {
                                              _vm.$set(
                                                vehicleCategories,
                                                "operator",
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("v-select", {
                                          ...
                                          model: {
                                            value: vehicleCategories.condition,
                                            callback: function($$v) {
                                              _vm.$set(
                                                vehicleCategories,
                                                "condition",
                                        ...
                                        directives: [
                                          {
                                            name: "show",
                                            rawName: "v-show",
                                            value: vehicleCategories.length > 1,
                                            expression:
