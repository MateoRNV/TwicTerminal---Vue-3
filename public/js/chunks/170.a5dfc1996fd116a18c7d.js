...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      userData: // validation rules
      _validations__WEBPACK_IMPORTED_MODULE_4__["required"],
  ...
  methods: {
    login: function login() {
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post("http://koboautos.com/twic-terminal/connect/api/login"); // this.$refs.loginForm.validate().then(success => {
      //     if (success) {
      //         useJwt
      //             .login({
