...
var useShopFiltersSortingAndPagination = function useShopFiltersSortingAndPagination() {
  var filters = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
    q: '',
  ...
  var sortBy = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
    text: 'Featured',
    value: 'featured'
  });
  var sortByOptions = [{
...
var useShopUi = function useShopUi() {
  ...
  var totalProducts = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
  return {
    itemView: itemView,
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @core/comp-functions/ui/app */ "./frontend/src/@core/comp-functions/ui/app.js");
/* harmony import */ var _ECommerceShopLeftFilterSidebar_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ECommerceShopLeftFilterSidebar.vue */ "./frontend/src/views/apps/e-commerce/e-commerce-shop/ECommerceShopLeftFilterSidebar.vue");
/* harmony import */ var _useECommerceShop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./useECommerceShop */ "./frontend/src/views/apps/e-commerce/e-commerce-shop/useECommerceShop.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    // SFC
    ShopLeftFilterSidebar: _ECommerceShopLeftFilterSidebar_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  setup: function setup() {
    var _useShopFiltersSortin = Object(_useECommerceShop__WEBPACK_IMPORTED_MODULE_3__["useShopFiltersSortingAndPagination"])(),
    ...
    var _useShopUi = Object(_useECommerceShop__WEBPACK_IMPORTED_MODULE_3__["useShopUi"])(),
        itemView = _useShopUi.itemView,
        itemViewOptions = _useShopUi.itemViewOptions,
        totalProducts = _useShopUi.totalProducts;

    var _useShopRemoteData = Object(_useECommerceShop__WEBPACK_IMPORTED_MODULE_3__["useShopRemoteData"])(),
        products = _useShopRemoteData.products,
        fetchProducts = _useShopRemoteData.fetchProducts;

    var _useResponsiveAppLeft = Object(_core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_1__["useResponsiveAppLeftSidebarVisibility"])(),
    ...
    fetchShopProducts();
    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([filters, sortBy], function () {
      fetchShopProducts();
    }, {
      deep: true
    });
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\vue\\libs\\vue-slider.scss 1:9                @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\e-commerce\\e-commerce-shop\\ECommerceShopLeftFilterSidebar.vue 143:9                                                         root stylesheet");
