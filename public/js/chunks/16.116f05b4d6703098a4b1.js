...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var onSubmit = function onSubmit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://koboautos.com/twic-terminal/connect/api/create_inspections?vin_number=' + userData.value.vin_number + '&driver_name=' + userData.value.driver_name + '&company_name=' + userData.value.companyName + '&customer=' + userData.value.customers, {
        headers: {
