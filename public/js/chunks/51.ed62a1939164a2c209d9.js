...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-inner-image-zoom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = (_components$mounted$c = {
  components: {
    'inner-image-zoom': !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-inner-image-zoom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  mounted: function mounted() {
    // this.getcountries();
    this.getinspectiondata(this.$route.params.id);
  }
}, _defineProperty(_components$mounted$c, "components", {
...
}), _defineProperty(_components$mounted$c, "props", {
  userData: {
    type: Object,
    required: true
  }
}), _defineProperty(_components$mounted$c, "setup", function setup() {
...
}), _defineProperty(_components$mounted$c, "directives", {
...
}), _defineProperty(_components$mounted$c, "created", function created() {
  var _this4 = this;
...
}), _defineProperty(_components$mounted$c, "data", function data() {
  return {
    profileData: {},
