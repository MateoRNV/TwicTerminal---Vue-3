  ...
  methods: {
    postData: function postData(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/create-status-list", {
        ...
        group_id: this.statusList.group_id,
                      ...
                      _c(
                        ...
                        [
                          _c("b-form-input", {
                            ...
                            attrs: { placeholder: "Enter Name", name: "title" },
                            model: {
                          ...
                          [
                            _c(
                              ...
                              [
                                ...
                                _vm._v(" "),
                                _vm._l(_vm.statusGroup, function(statusGroup) {
                                  return _c("option", { key: statusGroup.id }, [
                                    _vm._v(
                                      "\n                                    " +
                                        _vm._s(statusGroup.name) +
                                        "\n                                "
                                    )
                                  ])
                                })
