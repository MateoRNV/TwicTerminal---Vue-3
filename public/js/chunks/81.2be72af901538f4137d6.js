  ...
  methods: {
    formSubmit: function formSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default()({
        method: "post",
        url: "http://koboautos.com/twic-terminal/connect/api/create_user?first_name=" + this.userData.first_name + "&last_name=" + this.userData.last_name + "&email=" + this.userData.email + "&phone=" + this.userData.contact + "&gender=" + this.userData.gender + "&address=" + this.userData.address + "&country_id=" + this.userData.country.key + "&username=" + this.userData.username
      }).then(function (response) {
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: expected \"{\".\n    ╷\n497 │   justify content\n    │                  ^\n    ╵\n  C:\\xampp\\htdocs\\twic_terminal-june\\frontend\\src\\views\\user\\users-list\\UserListAddNew.vue 497:18  root stylesheet");
