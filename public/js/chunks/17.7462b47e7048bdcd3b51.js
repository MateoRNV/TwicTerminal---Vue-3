...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    vindecorder: function vindecorder(e) {
      ...
      this.userData.year_make_model = e.target.value;
      this.userData.year_make_model.dispatchEvent(new Event('input')); //searchvinnumber = document.getElementById('searchvinnumber').value;
