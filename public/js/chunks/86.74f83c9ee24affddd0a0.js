  ...
  methods: {
    getinspectiondata: function getinspectiondata(vin_number) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_22___default.a.post('http://koboautos.com/twic-terminal/connect/api/inspection-details-by-vin-number?vin_number=' + vin_number).then(function (response) {
        ...
        _this.inspection.id = response.data.inspectionDetails.id;
    ...
    addNotes: function addNotes(e) {
      ...
      console.log(this.inspection.id); // e.preventDefault();
      // let currentObj = this;
      //   axios({
      //     method: 'post',
      //     url: 'http://koboautos.com/twic-terminal/connect/api/create_inspections?vin_number=' + this.userData.vin_number+'&driver_name=' + this.userData.driver_name+'&company_name=' + this.userData.companyName+'&customer='+ this.userData.customerName,
      // })
      // .then(function (response) { 
      //   console.log(response);
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.inspection.id,
                                expression: "inspection.id"
                              }
                            ],
                            staticStyle: { display: "none" },
                            attrs: { type: "input" },
                            domProps: { value: _vm.inspection.id },
                            on: {
