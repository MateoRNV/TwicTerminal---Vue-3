  ...
  methods: {
    ...
    uploaddocuments: function uploaddocuments() {
      ...
      reader.onload = function () {
        ...
        axios__WEBPACK_IMPORTED_MODULE_22___default()({
          method: 'post',
          url: 'http://koboautos.com/twic-terminal/connect/api/upload-documents?vin_number=' + _this2.inspection.vin_number + '&document=' + reader.result + '&status_list_id=' + localStorage["note_row_id"]
        }).then(function (response) {
          console.log(response);
