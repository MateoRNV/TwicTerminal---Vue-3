...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      alphaNum: _validations__WEBPACK_IMPORTED_MODULE_1__["alphaNum"],
  ...
  setup: function setup(props, _ref) {
    ...
    var userData = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(JSON.parse(JSON.stringify(blankUserData)));
    ...
    var onSubmit = function onSubmit() {
      _store__WEBPACK_IMPORTED_MODULE_4__["default"].dispatch('app-user/addUser', userData.value).then(function () {
        emit('refetch-data');
        emit('update:is-add-new-user-sidebar-active', false);
      });
    };

    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_2__["default"])(resetuserData),
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _core_utils_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/utils/filter */ "./frontend/src/@core/utils/filter.js");
/* harmony import */ var _UsersListFilters_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UsersListFilters.vue */ "./frontend/src/views/apps/user/users-list/UsersListFilters.vue");
/* harmony import */ var _useUsersList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./useUsersList */ "./frontend/src/views/apps/user/users-list/useUsersList.js");
...
/* harmony import */ var _UserListAddNew_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./UserListAddNew.vue */ "./frontend/src/views/apps/user/users-list/UserListAddNew.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    UsersListFilters: _UsersListFilters_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    UserListAddNew: _UserListAddNew_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  setup: function setup() {
    ...
    if (!_store__WEBPACK_IMPORTED_MODULE_1__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_1__["default"].registerModule(USER_APP_STORE_MODULE_NAME, _userStoreModule__WEBPACK_IMPORTED_MODULE_5__["default"]); // UnRegister on leave

    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_1__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_1__["default"].unregisterModule(USER_APP_STORE_MODULE_NAME);
    });
    var isAddNewUserSidebarActive = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false);
    var roleOptions = [{
      label: 'Admin',
      value: 'admin'
    }, {
    ...
    var _useUsersList = Object(_useUsersList__WEBPACK_IMPORTED_MODULE_4__["default"])(),
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\vue\\libs\\vue-select.scss 4:9                @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\user\\users-list\\UsersList.vue 354:9                                                         root stylesheet");
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\vue\\libs\\vue-select.scss 4:9                @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\user\\users-list\\UsersListFilters.vue 105:9                                                         root stylesheet");
