...
function formValidation(resetFormData) {
  ...
  // ------------------------------------------------
  var refFormObserver = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null); // ------------------------------------------------
  // resetObserver
  ...
  var resetForm = function resetForm() {
    resetFormData();
    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      resetObserver();
    });
  }; // ------------------------------------------------
  // clearForm
...
var useResponsiveAppLeftSidebarVisibility = function useResponsiveAppLeftSidebarVisibility() {
  var mqShallShowLeftSidebar = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false); // Close Active Sidebars and other stuff when going in large device

  var currentBreakPoint = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
    return _store__WEBPACK_IMPORTED_MODULE_0__["default"].getters['app/currentBreakPoint'];
  });
  !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(currentBreakPoint, function (val, oldVal) {
...
var useRouter = function useRouter() {
  var vm = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().proxy;
  var state = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
    route: vm.$route
  });
  !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
    return vm.$route;
  ...
  return _objectSpread(_objectSpread({}, !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(state)), {}, {
    router: vm.$router
  });
};
/**
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/locale/ar.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/locale/en.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _validators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validators */ "./frontend/src/@core/utils/validations/validators.js");
...
var required = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('required', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var email = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('email', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var min = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('min', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var confirmed = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('confirmed', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var regex = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('regex', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var between = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('between', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var alpha = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('alpha', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var integer = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('integer', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var digits = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('digits', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var alphaDash = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('alpha-dash', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var alphaNum = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('alpha-num', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var length = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('length', !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var positive = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('positive', {
  validate: _validators__WEBPACK_IMPORTED_MODULE_1__["validatorPositive"],
  message: 'Please enter positive number!'
});
var credit = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('credit-card', {
  validate: _validators__WEBPACK_IMPORTED_MODULE_1__["validatorCreditCard"],
  message: 'It is not valid credit card!'
});
var password = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('password', {
  validate: _validators__WEBPACK_IMPORTED_MODULE_1__["validatorPassword"],
  message: 'Your {_field_} must contain at least one uppercase, one lowercase, one special character and one digit'
});
var url = !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('url', {
  validate: _validators__WEBPACK_IMPORTED_MODULE_1__["validatorUrlValidator"],
  message: 'URL is invalid'
}); // Install English and Arabic localizations.

!(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
  en: {
    messages: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/locale/en.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).messages,
    names: {
      email: 'Email',
      password: 'Password'
    },
  ...
  ar: {
    messages: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/locale/ar.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).messages,
    names: {
...
function useTaskHandler(props, emit) {
  ...
  // taskLocal
  // ------------------------------------------------
  var taskLocal = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(JSON.parse(JSON.stringify(props.task.value)));

  var resetTaskLocal = function resetTaskLocal() {
    taskLocal.value = JSON.parse(JSON.stringify(props.task.value));
  };

  !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(props.task, function () {
    resetTaskLocal();
  }); // ------------------------------------------------
...
/* harmony import */ var _core_utils_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @core/utils/utils */ "./frontend/src/@core/utils/utils.js");
/* harmony import */ var _core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @core/comp-functions/ui/app */ "./frontend/src/@core/comp-functions/ui/app.js");
/* harmony import */ var _TodoLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TodoLeftSidebar.vue */ "./frontend/src/views/apps/todo/TodoLeftSidebar.vue");
/* harmony import */ var _todoStoreModule__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./todoStoreModule */ "./frontend/src/views/apps/todo/todoStoreModule.js");
/* harmony import */ var _TodoTaskHandlerSidebar_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TodoTaskHandlerSidebar.vue */ "./frontend/src/views/apps/todo/TodoTaskHandlerSidebar.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    BFormInput: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BInputGroup: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BInputGroupPrepend: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BDropdown: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BDropdownItem: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BFormCheckbox: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BBadge: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BAvatar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    // App SFC
    TodoLeftSidebar: _TodoLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    TodoTaskHandlerSidebar: _TodoTaskHandlerSidebar_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  setup: function setup() {
    var TODO_APP_STORE_MODULE_NAME = 'app-todo'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_0__["default"].hasModule(TODO_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_0__["default"].registerModule(TODO_APP_STORE_MODULE_NAME, _todoStoreModule__WEBPACK_IMPORTED_MODULE_6__["default"]); // UnRegister on leave
    ...
    var _useRouter = Object(_core_utils_utils__WEBPACK_IMPORTED_MODULE_3__["useRouter"])(),
        route = _useRouter.route,
        router = _useRouter.router;

    var routeSortBy = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      return route.value.query.sort;
    });
    var routeQuery = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      return route.value.query.q;
    });
    var routeParams = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
      return route.value.params;
    });
    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(routeParams, function () {
      // eslint-disable-next-line no-use-before-define
      fetchTasks();
    });
    var tasks = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([]);
    var sortOptions = ['latest', 'title-asc', 'title-desc', 'assignee', 'due-date'];
    var sortBy = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(routeSortBy.value);
    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(routeSortBy, function (val) {
    ...
    var task = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(JSON.parse(JSON.stringify(blankTask)));
    ...
    var isTaskHandlerSidebarActive = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false);
    var taskTags = [{
      title: 'Team',
      color: 'primary',
      route: {
    ...
    var searchQuery = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(routeQuery.value);
    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(routeQuery, function (val) {
      searchQuery.value = val;
    }); // eslint-disable-next-line no-use-before-define

    !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())([searchQuery, sortBy], function () {
      return fetchTasks();
    });
    ...
    var _useResponsiveAppLeft = Object(_core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_4__["useResponsiveAppLeftSidebarVisibility"])(),
    ...
    return {
      ...
      // Filters
      formatDate: _core_utils_filter__WEBPACK_IMPORTED_MODULE_2__["formatDate"],
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-ripple-directive'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  directives: {
    Ripple: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-ripple-directive'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  components: {
    BButton: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BListGroup: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BListGroupItem: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    VuePerfectScrollbar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  props: {
    taskTags: {
  ...
  setup: function setup() {
    ...
    return {
      ...
      isDynamicRouteActive: _core_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isDynamicRouteActive"]
    };
  }
});
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-ripple-directive'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _validations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @validations */ "./frontend/src/@core/utils/validations/validations.js");
/* harmony import */ var _core_utils_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/utils/filter */ "./frontend/src/@core/utils/filter.js");
/* harmony import */ var _core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @core/comp-functions/forms/form-validation */ "./frontend/src/@core/comp-functions/forms/form-validation.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-quill-editor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _useTaskHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./useTaskHandler */ "./frontend/src/views/apps/todo/useTaskHandler.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    // BSV
    BButton: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BSidebar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BForm: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BFormGroup: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BFormInput: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BAvatar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    BFormInvalidFeedback: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    // 3rd party packages
    vSelect: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-select'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    flatPickr: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-flatpickr-component'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    quillEditor: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-quill-editor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    // Form Validation
    ...
    ValidationObserver: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  directives: {
    Ripple: !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-ripple-directive'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  ...
  data: function data() {
    return {
      ...
      url: _validations__WEBPACK_IMPORTED_MODULE_1__["url"]
    };
  },
  setup: function setup(props, _ref) {
    var emit = _ref.emit;

    var _useTaskHandler = Object(_useTaskHandler__WEBPACK_IMPORTED_MODULE_4__["default"])(!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(props), emit),
    ...
    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_3__["default"])(resetTaskLocal, props.clearTaskData),
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  frontend\\src\\@core\\scss\\vue\\libs\\vue-select.scss 4:9                @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\todo\\TodoTaskHandlerSidebar.vue 328:9                                                         root stylesheet");
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9  @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\apps\\todo\\TodoTaskHandlerSidebar.vue 334:9                                                         root stylesheet");
