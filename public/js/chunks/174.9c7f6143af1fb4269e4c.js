...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var userData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(JSON.parse(JSON.stringify(blankUserData)));
    ...
    var onSubmit = function onSubmit() {
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-user/addUser', userData.value).then(function () {
        emit('refetch-data');
