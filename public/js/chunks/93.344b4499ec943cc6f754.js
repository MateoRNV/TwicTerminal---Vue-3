...
/* harmony default export */ __webpack_exports__["default"] = (_components$props$set = {
  components: {
...
}, _defineProperty(_components$props$set, "setup", function setup() {
  var INVOICE_APP_STORE_MODULE_NAME = 'app-invoice'; // Register module

  if (!store.hasModule(INVOICE_APP_STORE_MODULE_NAME)) store.registerModule(INVOICE_APP_STORE_MODULE_NAME, invoiceStoreModule); // UnRegister on leave
  ...
  var _useInvoicesList = useInvoicesList(),
...
}), _defineProperty(_components$props$set, "directives", {
...
}), _defineProperty(_components$props$set, "data", function data() {
  return {
