...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addNotes: function addNotes(e) {
      e.preventDefault();
      console.log(localStorage["note_row_id"]); //console.log(this.AddInspectionNotes.description);

      if (this.AddInspectionNotes.description != '') {
        axios__WEBPACK_IMPORTED_MODULE_22___default()({
          method: 'post',
          url: 'http://koboautos.com/twic-terminal/connect/api/create-inspection-notes?vin_number=' + this.inspection.vin_number + '&description=' + this.AddInspectionNotes.description
        }).then(function (response) {
          console.log(response);

          if (response.status == 200) {
            currentObj.$router.push({
              path: '/inventory/view/' + this.inspection.vin_number
            });
          }
    ...
    updatenotes: function updatenotes(rowid, description) {
      ...
      localStorage["note_row_id"] = rowid; // if(this.AddInspectionNotes.description != ''){
      //         axios({
      //               method: 'post',
      //               url: 'http://koboautos.com/twic-terminal/connect/api/create-inspection-notes?vin_number=' + this.inspection.vin_number+'&description=' + this.AddInspectionNotes.description,
      //           })
      ...
      //             console.log(response);
      //             if (response.status == 200) { 
      //                currentObj.$router.push({ path : '/inventory/view/'+this.inspection.vin_number  });
      //               }
      //           })
      //           .catch(function (response) {
      //               if (response.status == 422) {
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [_vm._v(_vm._s(insactivity.added_on))]
                                  )
                                ]
                              ),
                              _vm._v(" "),
