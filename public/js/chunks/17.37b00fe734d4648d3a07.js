...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var onSubmit = function onSubmit() {
      ...
      _this.router.push("/inventory/list/1"); //router.stateService.go('inventory/list/1');
  ...
  methods: {
    ...
    vindecorder: function vindecorder(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('https://shipafrika.com/api/getcrossdata/decodevin.php?vin=' + vin_number).then(function (response) {
        _this2.userData.year_make_model = response.data.model_year + ' | ' + response.data.make + ' | ' + response.data.model;
      });
    },
