...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var onSubmit = function onSubmit() {
      //  let currentObj = this;
      console.log(userData.value.vin_number); //  // axios.post('http://koboautos.com/twic-terminal/connect/api/create_inspections?vin_number=' + userData.value.vin_number+'&driver_name=' + userData.value.driver_name+'&company_name=' + userData.value.companyName+'&customer=Abdul sSalam')
      //  //   .then(response => {
      //  //     // this.laravelData = response.data.Inspection;
  ...
  methods: {
    ...
    vindecorder: function vindecorder(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('https://shipafrika.com/api/getcrossdata/decodevin.php?vin=' + vin_number).then(function (response) {
        _this.userData.year_make_model = response.data.model_year + ' | ' + response.data.make + ' | ' + response.data.model;
      });
    },
    allcustomers: function allcustomers(e) {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://koboautos.com/twic-terminal/connect/api/customerdropdownlist').then(function (response) {
        _this2.customerdropdownlist = response.data.customers;
      });
    },
