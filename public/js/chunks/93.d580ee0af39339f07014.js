...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    if (!store.hasModule(INVOICE_APP_STORE_MODULE_NAME)) store.registerModule(INVOICE_APP_STORE_MODULE_NAME, !(function webpackMissingModule() { var e = new Error("Cannot find module './invoiceStoreModule'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // UnRegister on leave
