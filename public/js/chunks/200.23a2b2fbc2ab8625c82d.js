            ...
            _c(
              ...
              [
                        ...
                        _c(
                          ...
                          [
                            _c("v-select", {
                              ...
                              model: {
                                value: _vm.statusList.group_id,
                                callback: function($$v) {
                                  _vm.$set(_vm.statusList, "group_id", $$v)
                                },
                                expression: "statusList.group_id"
                              }
                            })
                          ],
                          1
                ...
                _c(
                  ...
                  {
                    ref: "row",
                    staticClass: "repeater-form mb-2",
                    style: { height: _vm.trHeight }
                  },
                  [
                    _vm._l(_vm.statuswithcolors, function(input, index) {
                      return _c(
                        "b-col",
                        {
                        ...
                        [
                          _c(
                            "b-row",
                            { ref: "row", refInFor: true, staticClass: "mb-2" },
                            [
