  ...
  methods: {
    postData: function postData(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/create-vehicle-categories", {
        ...
        basis: this.vehicleCategories.basis.title,
        part: this.vehicleCategories.part.title,
        unit: this.vehicleCategories.unit.title,
        operator: this.vehicleCategories.operator.title,
        value: this.vehicleCategories.value,
        condition: this.vehicleCategories.condition.title
      }, {
        headers: {
