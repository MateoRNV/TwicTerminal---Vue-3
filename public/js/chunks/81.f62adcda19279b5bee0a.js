  ...
  methods: {
    formSubmit: function formSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default()({
        method: "post",
        url: "http://koboautos.com/twic-terminal/connect/api/create_user?first_name=" + this.userData.first_name + "&last_name=" + this.userData.last_name + "&email=" + this.userData.email + "&phone=" + this.userData.contact + "&gender=" + this.userData.gender + "&address=" + this.userData.address + "&country_id=" + this.userData.country.key + "&username=" + this.userData.username + "&terminal=" + this.customerinfo.terminal
      }).then(function (response) {
