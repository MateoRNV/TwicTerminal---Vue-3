...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.allcustomersgroups(this.$route.params.id);
  },
  data: function data() {
    return {
  ...
  methods: (_methods = {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('http://koboautos.com/twic-terminal/connect/api/create_group').then(function (response) {
      ...
      _this3.customergroupdropdownlist = response.data.customergroups;
    });
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default()({
      method: "post",
      url: "http://koboautos.com/twic-terminal/connect/api/update_customer?key=" + rowid,
                    ...
                    [
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _vm._l(_vm.allcustomersgroups, function(
                            customer,
                            key
                          ) {
                            return _c("option", { attrs: { value: "22" } }, [
                              _vm._v("Auction/Warehouse")
                            ])
                          }),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "18" } }, [
                            _vm._v("Inland or Ocean Transportation agent")
                          ])
                        ],
                        2
                      ),
                      ...
                      _c("v-select", {
                        attrs: {
                          item: _vm.allcustomersgroups(function(item) {
                            return item.title
                          })
                        }
                      }),
                      ...
                      _c(
                        "select",
                        {
                          ...
                          staticClass: "vue-select form-control",
                          on: {
                            change: function($event) {
                              var $$selectedVal = Array.prototype.filter
                                .call($event.target.options, function(o) {
                        ...
                        _vm._l(_vm.allcustomersgroups, function(customer) {
                          return _c(
                            "option",
                            {
                              key: customer.first_name,
                              domProps: { value: customer.first_name }
                            },
