...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nError: ENOENT: no such file or directory, open 'C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\views\\inventory\\inventory-list\\useUsersList.js'");
                                ...
                                return [
                                  _c("b-avatar", {
                                    attrs: {
                                      ...
                                      text: _vm.avatarText(data.item.date),
                                      variant:
                                        "light-" +
                    ...
                    _c(
                      ...
                      [
                        _c("feather-icon", {
                          ...
                          class:
                            "text-" +
                            _vm.resolveUserRoleVariant(_vm.data.item.number),
                          attrs: {
                            icon: _vm.resolveUserRoleIcon(_vm.data.item.number),
                            size: "18"
                          }
                        }),
                        _vm._v(" "),
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.data.item.number))]
                        )
                      ],
                      1
                    )
                    ...
                    _c(
                      ...
                      [
                        _c("feather-icon", {
                          ...
                          class:
                            "text-" +
                            _vm.resolveUserRoleVariant(data.item.duration),
                          attrs: {
                            icon: _vm.resolveUserRoleIcon(data.item.duration),
                            size: "18"
                          }
                        }),
                        _vm._v(" "),
                        _c(
                          "span",
                          { staticClass: "align-text-top text-capitalize" },
                          [_vm._v(_vm._s(data.item.duration))]
                        )
                      ],
                      1
                    )
