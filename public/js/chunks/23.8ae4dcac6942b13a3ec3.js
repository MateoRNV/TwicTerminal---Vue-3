...
var useScrollListener = function useScrollListener() {
  var scrolledTo = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
...
function useHorizontalNavMenuGroup(item) {
  ...
  // childDropdown
  // ------------------------------------------------
  var refChildDropdown = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null);
  var openChildDropdownOnLeft = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(false); // ------------------------------------------------
  // isActive
  // ------------------------------------------------
...
function useLayoutHorizontal(navbarMenuType, footerType, isVerticalMenuActive) {
  ...
  var navbarMenuTypeClass = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vue/composition-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _core_layouts_components_layout_content_renderer_LayoutContentRendererDefault_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @core/layouts/components/layout-content-renderer/LayoutContentRendererDefault.vue */ "./frontend/src/@core/layouts/components/layout-content-renderer/LayoutContentRendererDefault.vue");
/* harmony import */ var _core_layouts_components_layout_content_renderer_LayoutContentRendererLeft_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @core/layouts/components/layout-content-renderer/LayoutContentRendererLeft.vue */ "./frontend/src/@core/layouts/components/layout-content-renderer/LayoutContentRendererLeft.vue");
/* harmony import */ var _core_layouts_components_layout_content_renderer_LayoutContentRendererLeftDetached_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @core/layouts/components/layout-content-renderer/LayoutContentRendererLeftDetached.vue */ "./frontend/src/@core/layouts/components/layout-content-renderer/LayoutContentRendererLeftDetached.vue");
/* harmony import */ var _useLayoutHorizontal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./useLayoutHorizontal */ "./frontend/src/@core/layouts/layout-horizontal/useLayoutHorizontal.js");
/* harmony import */ var _components_horizontal_nav_menu_HorizontalNavMenu_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/horizontal-nav-menu/HorizontalNavMenu.vue */ "./frontend/src/@core/layouts/layout-horizontal/components/horizontal-nav-menu/HorizontalNavMenu.vue");
/* harmony import */ var _core_layouts_layout_vertical_components_vertical_nav_menu_VerticalNavMenu_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @core/layouts/layout-vertical/components/vertical-nav-menu/VerticalNavMenu.vue */ "./frontend/src/@core/layouts/layout-vertical/components/vertical-nav-menu/VerticalNavMenu.vue");
/* harmony import */ var _core_layouts_layout_vertical_useVerticalLayout__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @core/layouts/layout-vertical/useVerticalLayout */ "./frontend/src/@core/layouts/layout-vertical/useVerticalLayout.js");
/* harmony import */ var _mixinLayoutHorizontal__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./mixinLayoutHorizontal */ "./frontend/src/@core/layouts/layout-horizontal/mixinLayoutHorizontal.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    HorizontalNavMenu: _components_horizontal_nav_menu_HorizontalNavMenu_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
    BNavbar: !(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap-vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    // Content Renderer
    LayoutContentRendererDefault: _core_layouts_components_layout_content_renderer_LayoutContentRendererDefault_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    LayoutContentRendererLeft: _core_layouts_components_layout_content_renderer_LayoutContentRendererLeft_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    LayoutContentRendererLeftDetached: _core_layouts_components_layout_content_renderer_LayoutContentRendererLeftDetached_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    // Vertical Menu
    VerticalNavMenu: _core_layouts_layout_vertical_components_vertical_nav_menu_VerticalNavMenu_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
  },
  mixins: [_mixinLayoutHorizontal__WEBPACK_IMPORTED_MODULE_14__["default"]],
  computed: {
  ...
  setup: function setup() {
    ...
    var _useVerticalLayout = Object(_core_layouts_layout_vertical_useVerticalLayout__WEBPACK_IMPORTED_MODULE_13__["default"])(navbarType, footerType),
    ...
    var _useLayoutHorizontal = Object(_useLayoutHorizontal__WEBPACK_IMPORTED_MODULE_10__["default"])(navbarType, footerType, isVerticalMenuActive),
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  frontend\\src\\@core\\scss\\base\\bootstrap-extended\\_include.scss 14:9           @import\n  frontend\\src\\@core\\scss\\base\\core\\menu\\menu-types\\horizontal-menu.scss 12:9  @import\n  C:\\xampp\\htdocs\\twic_terminal\\frontend\\src\\@core\\layouts\\layout-horizontal\\components\\horizontal-nav-menu\\HorizontalNavMenu.vue 24:9                                                                   root stylesheet");
