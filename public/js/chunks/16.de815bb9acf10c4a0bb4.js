...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.vindecorder(vinnumber);
  },
  methods: {
    // Our method to GET results from a Laravel endpoint
    vindecorder: function vindecorder(vinnumber) {
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('https://shipafrika.com/api/getcrossdata/decodevin.php?vin=' + vinnumber).then(function (response) {
