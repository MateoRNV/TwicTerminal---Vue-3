...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_model, "prop", 'isAddNewCustomerSidebarActive'), _defineProperty(_model, "event", 'update:is-add-new-user-sidebar-active'), _model),
  props: {
  ...
  methods: {
    ...
    addnewcustomer: function addnewcustomer(e) {
      //$("#myModal").model('show');
      isAddNewCustomerSidebarActive = true;
...
var render = function() {
  ...
  return _c("b-sidebar", {
    attrs: {
      ...
      visible: _vm.isAddNewCustomerSidebarActive,
      "bg-variant": "white",
                  ...
                  _c("textarea", {
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.$set(_vm.userData, "note", $event.target.value)
                      }
                    }
                  })
                ]),
