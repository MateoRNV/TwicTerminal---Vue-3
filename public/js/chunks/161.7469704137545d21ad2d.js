...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getResults: function getResults() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://koboautos.com/twic-terminal/connect/api/inspectiontypes?page=" + page, {
        headers: {
        ...
        _this.inspectiontypes = response.data.inspectiontypes; // this.inventoryduration = response.data.inventoryduration;
          ...
          _c(
            ...
            [
              ...
              _c(
                "tbody",
                { attrs: { role: "rowgroup" } },
                _vm._l(_vm.inspectiontypes.data, function(inspection, index) {
                  return _c("tr", [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          "router-link",
                          {
                            attrs: { to: "/inspection/update/" + inspection.id }
                          },
              ...
              [
                _c(
                  ...
                  [
                    _c("span", { staticClass: "text-muted" }, [
                      _vm._v(
                        "Showing " +
                          _vm._s(_vm.inspectiontypes.from) +
                          " to\n                        " +
                          _vm._s(_vm.inspectiontypes.to) +
                          " of\n                        " +
                          _vm._s(_vm.inspectiontypes.of) +
                          " entries"
                      )
                    ])
                  ]
                ...
                _c(
                  ...
                  [
                    _c("b-pagination", {
                      attrs: {
                        "total-rows": _vm.inspectiontypes.total,
