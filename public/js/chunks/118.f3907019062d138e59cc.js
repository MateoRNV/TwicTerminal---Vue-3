  ...
  methods: {
    ...
    customerformSubmit: function customerformSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default()({
        ...
        if (response.status == 200) {
          alert(1); // console.log(response.data.value);
          // console.log(response.data.title);
          //this.customerswithcompany.push(response.data.newcustomer);
          //this.$root.$on("bv::close::modal", "modal-1");
          //$('#modal-1').modal('hide');

          this.$refs.Close.click(); // this.$root.$on('bv::modal::hide', (bvEvent, modalId) => {
