...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_model, "prop", 'isAddNewCustomeridebarActive'), _defineProperty(_model, "event", 'update:is-add-new-user-sidebar-active'), _model),
  props: {
  ...
  methods: {
    ...
    addnewcustomer: function addnewcustomer(e) {
      isAddNewUserSidebarActive = false;
      isAddNewCustomeridebarActive = true; //$("#myModal").model('show');
